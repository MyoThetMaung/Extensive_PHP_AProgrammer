    ...
    if($_POST){
        ...
        if($user){
            ...
            $statement = $pdo ->prepare("UPDATE users SET name='$name', email='$email',
                         phone='$phone', address='$address', role='$role', password='$password' WHERE id=$id");
                        ...
                        <div class="card-body">
                            ...
                            <input type="hidden" name="id" value="<?php echo escape($user['id']); ?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="phone" class="form-control" value="<?php echo escape($user['phone']);?>">
                                </div>
                                <div class="form-group">
                                    <label for="">Address</label> <p style="color:red;"><?php echo empty($address_error) ? "" : $address_error; ?></p>
                                    <input type="text" name="address" class="form-control" value="<?php echo escape($user['address']);?>">
                                </div>
                                <div class="form-group">
