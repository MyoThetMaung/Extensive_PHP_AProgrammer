              ...
              <table class="table table-bordered">
                ...
                if ($result) {
                  foreach ($result as $value) { ?>
                    ...
                    <td>
                        <div class="d-flex">
                        <a href="user_edit.php?id=<?php echo $value['id']; ?>" class="btn btn-warning m-1" type="button">Edit</a>                
                            <a href="user_delete.php?id=<?php echo $value['id']; ?>" class="btn btn-danger m-1" type="button" onclick="return confirm('will you delete user?');">Delete</a>                   
                        </div>
                    </td>
                    </tr>
                <?php
